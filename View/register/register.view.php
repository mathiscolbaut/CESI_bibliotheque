<h1 class="text-blue-600 text-3xl text-center">S'enregister</h1>
...
<body class="d-flex justify-content-center align-items-center text-center">
    <div id="login-one" class="login-one">
        <form class="login-one-form" action="registerUser" method="POST">
            <div class="col-md-3 mx-auto">
                <div class="login-one-ico"><i id="lockico" class="fa fa-unlock-alt"></i></div>
                <div class="form-group mb-3">
                    
                    <input id="user" name="nom" class="form-control" type="text" placeholder="Nom d'utilisateur" />
                    <br />
